...
export default function Profile() {
    ...
    const deleteProfile = async (event: any) => {
        event.preventDefault();
        // TODO: need to update the output of the deleteUser func
    ...
    return (
        <div className="h-full my-3 py-3">
            ...
            <div className="flex justify-center">
                <button className="mx-auto bg-red-700 text-slate-100 w-28 h-14 rounded-md hover:bg-red-600 hover:shadow-md shadow-slate-400 hover:shadow-slate-800 py-3 " onClick={deleteProfile}>Delete Profile</button>
            </div>
        </div>

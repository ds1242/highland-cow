                                ...
                                scanList.map(product => (
                                    <tr className='h-14' key={product.scan_id}>
                                        ...
                                        <td className='border border-slate-600 bg-slate-200 px-3 text-center'>
                                            <button className='px-2 mx-2' onClick={(event) => addOnClick(event, product.scan_id, product.quantity)}>
                                            ...
                                            <button className='px-2 mx-2' onClick={(event) => subtractOnClick(event, product.scan_id, product.quantity)}>
                                                <svg width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
